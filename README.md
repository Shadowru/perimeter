...
2. **Обратное подключение** — внешняя обработка внутри сеанса 1С сама опрашивает «Периметр». Публикация не нужна, входящих соединений к 1С нет; работает и на базовой версии. Установка и протокол — `bridge-1c/robot1c/README.md`.
